...
Dice actions (`prob`, `ev`, `dist`) keep the palette open and display the result inline. The expression syntax supports standard dice notation: `2d6`, `4d6kh3` (keep highest 3), `1d20 + 5`, etc. Examples:
